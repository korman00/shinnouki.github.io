      ...
      try{
    		...
    		if (m!=null){
    			if (m.equals("failure")){
    				...
    				%><script type="text/javascript">
    					alert("You have succeeded in your update! Please click on View/Delete Layover to double check the information inserted.");
    				</script> <%	}
    		}
    		else {}
      }
  ...
  <div id="content">
    <div class="col">
	 ...
	 <li><a href='adminUpdateLayover.jsp'>Update Layover</a></li>
      ...
      <div>
      Enter the final destination to update. <br/>
      <form action="processUpdateLayover.jsp">
      Final Destination :<select name="destCountry">
		<%
      try{
    		Class.forName("com.mysql.jdbc.Driver");
    		String connURL="jdbc:mysql://localhost/spairline?user=root&password=abc12345";
    		Connection conn = DriverManager.getConnection(connURL);
    		Statement stmt = conn.createStatement();
    		String sqlStr="select distinct destCountry from spairline.layover";
	  ...
	  <option value="destCountry">Final Destination</option>
	  <option value="originCountry">Origin Country</option>
	  <option value="layoverCountry">Layover Country</option>
	  <option value="layoverCountry2">Layover Country 2</option>
	  <option value="LayoverDuration">Layover Duration</option>
	  </select> <br />
