...
try{
		...
		if (m!=null){
			if (m.equals("failure")){
				...
				%><script type="text/javascript">
					alert("You have succeeded in your insertion! Please click on View/Delete Cost of Flights to double check the information inserted.");
				</script> <%	}
		}
		else {}
}
  ...
  <div id="content">
    <div class="col">
	 ...
	 <li><a href='adminUpdateLayover.jsp'>Update Layover</a></li>
      ...
      <h2> Insert Cost of Flights </h2>
      <form id="insertAircraft" action="processCreateCost.jsp">
      Destination Country : <input type="text" name="destCountry">
      <br />
      Origin Country : <input type="text" name="originCountry">
      <br />
      Economy Cost ($) : <input type="text" name="economyCost">
      <br />
      Business Cost ($) : <input type="text" name="businessCost">
      <br />
      First Class Cost ($) : <input type="text" name="firstCost">
      <br />
