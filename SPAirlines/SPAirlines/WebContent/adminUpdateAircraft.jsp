      ...
      try{
    		...
    		if (m!=null){
    			if (m.equals("failure")){
    				...
    				%><script type="text/javascript">
    					alert("You have succeeded in your update! Please click on View/Delete Aircraft to double check the information inserted.");
    				</script> <%	}
    		}
    		else {}
      }
  ...
  <div id="content">
    <div class="col">
	 ...
	 <li><a href='adminUpdateLayover.jsp'>Update Layover</a></li>
      ...
      <div>
      Enter an aircraft ID to update. <br/>
      <form action="processUpdateAircraft.jsp">
      Aircraft ID : <select name="aircraftID">
		<%
      try{
    		Class.forName("com.mysql.jdbc.Driver");
    		String connURL="jdbc:mysql://localhost/spairline?user=root&password=abc12345";
	  ...
	  <option value="aircraftNo">Aircraft Number</option>
	  <option value="capacity">Capacity</option>
	  <option value="name">Employee</option>
	  <option value="image">Image (Filepath + \image.filetype)</option>
	  </select>
	  <br />
